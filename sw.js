...
const SHELL_FILES = [
  ...
  './src/main.js?v=biplane-mobile-audio-controls-v3',
  './src/config.js',
  './src/input.js',
  './src/flightModel.js',
  './src/collision.js',
  './src/camera.js',
  './src/effects.js',
  './src/aircraftVisuals.js?v=biplane-mobile-audio-controls-v3',
  './src/skyDecor.js',
  './src/atmosphere.js',
  './src/windAudio.js?v=biplane-mobile-audio-controls-v3',
  './src/routeSystem.js',
  './src/sandboxDynamics.js',
  './src/aiTraffic.js',
  './src/cloudField.js',
  './src/contrails.js',
  './src/worldPolish.js?v=biplane-mobile-audio-controls-v3',
  ...
  './src/hud.js',
  './src/world/world.js',
  './src/expansion/radioBeacon.js?v=biplane-mobile-audio-controls-v3',
  './src/audio/zeroRadioAudio.js?v=biplane-mobile-audio-controls-v3',
  './src/audio/stukaDiveSiren.js?v=biplane-mobile-audio-controls-v3',
